 ...
 * Use the {@link FragmentGood#newInstance} factory method to
...
public class FragmentGood extends Fragment {
    ...
    public static FragmentGood newInstance(String param1, String param2) {
        FragmentGood fragment = new FragmentGood();
